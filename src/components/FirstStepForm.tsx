    ...
    return ( 
        <div className="z-10 bg-White py-4 px-3 rounded-lg mt-[10%] w-[94%]">
            ...
            <form>
                ...
                <input className="w-full border border-Light-gray rounded-md text-Cool-gray font-Medium text-base p-3 mb-4" placeholder="e.g. Stephen King" {...register('name', {
                ...
                <input className="w-full border border-Light-gray rounded-md text-Cool-gray font-Medium text-base p-3 mb-4" placeholder="e.g stephenking@lorem.com" {...register('email', {
                    required: 'Fill in the form.',
                    pattern: {
                        value: /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{4,}))$/,
                ...
                <input className="w-full border border-Light-gray rounded-md text-Cool-gray font-Medium text-base p-3 mb-4" placeholder="e.g. +1-234-567-890" {...register('phoneNumber', {
                    required: 'Fill in the form.',
                    pattern: {
